...
init -1 python hide:
    ...
    config.window_title = u"Online Shopping"
    ...
    config.main_menu_music = "Pink Floyd - wish you were here guitar backing track.mp3"
...
python early:
    config.save_directory = "Online Shopping-1429328772"
